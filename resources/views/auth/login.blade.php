...
<section class="auth-wrap">
    <div class="auth-card">
        ...
        <div class="demo-box"><strong>Akun akses</strong><code>admin@puskesmas.test / password</code><code>petugas_asemrowo@test / password</code><code>masyarakat1@puskesmas.test / password</code></div>
