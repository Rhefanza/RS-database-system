...
<section class="auth-wrap">
    <div class="auth-card wide">
        ...
        <p>NIK harus sudah tersedia pada data dummy Dinas Kesehatan dan belum pernah diaktivasi.</p>
        ...
        <div class="demo-box"><strong>NIK yang belum aktif untuk demo</strong><code>3578010101900004</code></div>
    </div>
</section>
@endsection
